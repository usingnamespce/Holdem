...
{
	// If Holdem is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Holdem.Build.cs is not automatically propagated
